						...
						<div class="cell small-12 large-10 large-offset-1">
							<nav class="page-nav">
								...
								<div class="page-nav-wrap">
									<div class="grid-x grid-margin-x flex-dir-column medium-flex-dir-row align-middle" data-smooth-scroll data-animation-easing="swing">
		...
		<div class="grid-x grid-margin-x">
			<div class="cell small-12 large-10 large-offset-1">
				<nav class="page-nav">
					...
					<button class="hide-for-medium black-bg" type="button" id="page-nav-toggle"></button>
					<div class="page-nav-wrap">
						<div class="grid-x grid-margin-x flex-dir-column medium-flex-dir-row align-middle">
