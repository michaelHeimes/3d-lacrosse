...
<div class="team-card cell">
	<div class="inner grid-x flex-dir-column align-middle align-justify">
		<div class="top grid-x flex-dir-column align-middle">
		...
		<div class="btn-wrap">
			<button class="button chev-link grid-x align-middle" data-open="person-<?php echo $row ;?>">
				<span>Bio</span>
